...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: BP4_Start(void)
;  FUNCTION NAME: BP4_Stop(void)
;
;  FUNCTION NAME: BP4_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(0)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],BP4_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~BP4_PinMask
ENDIF
   jmp  .Switch_LED
...
_BP4_Invert:
 BP4_Invert:
   ...
   xor  [Port_0_Data_SHADE],BP4_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[BP4_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: BP4_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,BP4_PinMask                 ; Mask off the trash
