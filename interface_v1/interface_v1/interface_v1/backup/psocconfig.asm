...
export LoadConfig_telecommande_clem_2
export _LoadConfig_telecommande_clem_2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_telecommande_clem_2
	lcall	LoadConfigTBL_telecommande_clem_2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration telecommande_clem_2
;
;    Load configuration registers for telecommande_clem_2.
...
;               CUR_PP
;
_LoadConfig_telecommande_clem_2:
 LoadConfig_telecommande_clem_2:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_telecommande_clem_2_Bank0
    mov     X, <LoadConfigTBL_telecommande_clem_2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_telecommande_clem_2_Bank1
    mov     X, <LoadConfigTBL_telecommande_clem_2_Bank1
